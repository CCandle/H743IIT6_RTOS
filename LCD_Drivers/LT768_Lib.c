...
void System_Check_Temp(void) {
  ...
  do {
    ...
    if (((temp = LCD_StatusRead()) & 0x02) == 0x00) {
      vTaskDelay(pdMS_TO_TICKS(10)); // ��MCU �ٶ�̫�죬��Ҫ�rʹ��
      LCD_CmdWrite(0x01);
      vTaskDelay(pdMS_TO_TICKS(10)); // ��MCU �ٶ�̫�죬��Ҫ�rʹ��
      temp = LCD_DataRead();
...
//     unsigned char max_retries = 10; // ������Դ���
//     unsigned char temp = 0;
////    system_ok = 0;
//
//    // �ȵȴ�һ��ʱ����оƬ�ȶ�
...
//			z++;
//        // ���״̬�Ĵ����Ƿ��д
//        if((LCD_StatusRead() & 0x02) == 0x00)    // ���״̬�Ĵ���bit1(æ��־)
//        {
//            vTaskDelay(2); // ��Ҫ��ʱ
//
//            // ��ȡCCR�Ĵ���(0x01)
...
//        }
//
//    } while(system_ok == 0 && retry_count < 30); // ����������Դ���
//
//    // ����״̬���
//    if(system_ok == 0) {
//        // �������ʧ�ܣ����Լ�¼������ȡ������ʩ
...
//    // ���û�ͼ����Ϊ��Բ
//    LCD_CmdWrite(0x68); // ��ͼ����Ĵ���
//    LCD_DataWrite(0x04); // ��Բ����

//    // ����Բ������Ͱ뾶
//    LCD_CmdWrite(0x69); // Բ��X�����8λ
//    LCD_DataWrite(x0 & 0xFF);
//    LCD_CmdWrite(0x6A);
//    LCD_DataWrite((x0 >> 8) & 0xFF);

//    LCD_CmdWrite(0x6B); // Բ��Y�����8λ
//    LCD_DataWrite(y0 & 0xFF);
//    LCD_CmdWrite(0x6C);
//    LCD_DataWrite((y0 >> 8) & 0xFF);

//    LCD_CmdWrite(0x6D); // �뾶��8λ
//    LCD_DataWrite(radius & 0xFF);
//    LCD_CmdWrite(0x6E);
//    LCD_DataWrite((radius >> 8) & 0xFF);

//    // ������ͼ����
//    LCD_CmdWrite(0x67); // ��ͼ�����Ĵ���
//    LCD_DataWrite(0x01); // ��ʼ��ͼ

//    // �ȴ���ͼ���
//    while(LCD_StatusRead() & 0x01); // �ȴ���ͼæ����
//}
...
void LT768_DrawQuadrangular(
    unsigned short X1, unsigned short Y1, unsigned short X2, unsigned short Y2, unsigned short X3, unsigned short Y3, unsigned short X4, unsigned short Y4, unsigned short X5, unsigned short Y5, unsigned short X6, unsigned short Y6, unsigned long QuadrangularColor // ������ɫ
    ,
    unsigned long ForegroundColor // ������ɫ
) {
