...
#define color256_nothing   0xff
#define color256_red       0xe0
#define color256_deepblue  0x1c
#define color256_black2    0x03
#define color256_purple  color256_red|color256_deepblue     //������ʹ��
#define color256_blue    color256_deepblue|color256_black		//������ʹ��
#define color256_cyan    color256_red|color256_black        //������ʹ��
